...
namespace WYW.UI.Controls
{
    ...
    public class ImageViewer : Control
    {
        ...
        public ImageViewer()
        {
            CommandBindings.Add(new CommandBinding(CustomCommand.SaveCommand, ButtonSave_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.OpenCommand, ButtonWindowsOpen_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.RestoreCommand, ButtonActual_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.ReduceCommand, ButtonReduce_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.EnlargeCommand, ButtonEnlarge_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.RotateLeftCommand, ButtonRotateLeft_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.RotateRightCommand, ButtonRotateRight_OnClick));
            CommandBindings.Add(new CommandBinding(CustomCommand.MouseMoveCommand, ImageMain_OnMouseDown));
        ...
        public static readonly DependencyProperty ShowToolBarProperty = DependencyProperty.Register(
            nameof(ShowToolBar), typeof(bool), typeof(ImageViewer), new PropertyMetadata(true));
        ...
        internal static readonly DependencyProperty ImageWidthProperty = DependencyProperty.Register(
            nameof(ImageWidth), typeof(double), typeof(ImageViewer), new PropertyMetadata(0.0));

        internal static readonly DependencyProperty ImageHeightProperty = DependencyProperty.Register(
            nameof(ImageHeight), typeof(double), typeof(ImageViewer), new PropertyMetadata(0.0));

        internal static readonly DependencyProperty ImageScaleProperty = DependencyProperty.Register(
            nameof(ImageScale), typeof(double), typeof(ImageViewer), new PropertyMetadata(1.0, OnImageScaleChanged));
        ...
        internal static readonly DependencyProperty ImageRotateProperty = DependencyProperty.Register(
            nameof(ImageRotate), typeof(double), typeof(ImageViewer), new PropertyMetadata(0.0));
        ...
        {
            switch (MoveGesture.MouseAction)
            {
        ...
        private void OnMoveGestureChanged(MouseGesture newValue)
        {
            ...
            _mouseMoveBinding = new MouseBinding(CustomCommand.MouseMoveCommand, newValue);
